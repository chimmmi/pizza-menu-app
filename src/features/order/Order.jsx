...
function Order() {
  //*Retriving data from the loader in the URL
  const order = useLoaderData();
  //*Retrieves data from another page
  ...
  // console.log(fetcher.data[0]?.ingredients);
  ...
  return (
    <div className="space-y-8 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-2">
        <h2 className="font-smibold text-xl">Order #{id} status</h2>
